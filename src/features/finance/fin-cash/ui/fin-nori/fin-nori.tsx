...
import { createFin } from "../../actions/create-fin-cash";
import { FIN_CASH_ITEMS_LIST } from "../../model/constants";
import { defaultFinCashForm, finCashSchema, FinForm } from "../../model/schema";
...
export default function FinNori({
  finCashData,
  year,
}: {
