...
export type DataStatusLabels = Record<string, string[]>;

export type DataStatusParameters = {
  platinum: DataStatusLabels;
  gold: DataStatusLabels;
  silver: DataStatusLabels;
  loyal: DataStatusLabels;
};
